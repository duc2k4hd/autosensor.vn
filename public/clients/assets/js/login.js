...
(function () {
    const form = document.querySelector('.autosensor_form_login');
    if (!form) {
        return;
    }

    const emailInput = form.querySelector('.autosensor_form_login_email');
    const passwordInput = form.querySelector('.autosensor_form_login_password');
    const emailMessage = form.querySelector('.autosensor_message_email');
    const passwordMessage = form.querySelector('.autosensor_message_password');
