...
@section('title', 'Chính sách bảo mật - ' . ($settings->site_name ?? $settings->subname ?? 'AutoSensor Việt Nam'))

@section('head')
    <meta name="description"
          content="Chính sách bảo mật {{ $settings->site_name ?? 'AutoSensor Việt Nam' }} - cách thu thập, sử dụng và bảo vệ dữ liệu cá nhân của khách hàng.">
...
<div class="policy-page">
    ...
    <section class="policy-hero">
        ...
        <p>
            <strong>AutoSensor Việt Nam</strong> tôn trọng tuyệt đối quyền riêng tư của bạn. Chính sách này mô tả cách chúng tôi
            thu thập, sử dụng, lưu trữ và bảo vệ dữ liệu cá nhân trong mọi hoạt động mua sắm tại
            <a href="{{ $settings->site_url ?? '#' }}">{{ $settings->site_name ?? 'AutoSensor Việt Nam' }}</a>.
        </p>
    ...
    <section class="policy-section">
        ...
        <ul class="policy-list">
            <li>Ban quản lý website <strong>autosensor.vn</strong>.</li>
