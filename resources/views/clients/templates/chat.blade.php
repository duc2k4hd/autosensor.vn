...
<section>
    ...
    <div class="xanhworld_chat_popup" id="xanhworldChatPopup" data-endpoint="{{ $aiChatEndpoint }}">
        <div class="xanhworld_chat_panel" role="dialog" aria-modal="true" aria-label="Trợ lý AutoSensor Việt Nam">
            <div class="xanhworld_chat_header">
                <div>
                    <p class="xanhworld_chat_title">Trợ lý AutoSensor Việt Nam</p>
                    <p class="xanhworld_chat_desc">Hỏi mọi thứ về sản phẩm, bài viết, giải pháp kỹ thuật</p>
                </div>
            ...
            <div class="xanhworld_chat_tab_content active" data-tab-content="chat">
                ...
                <form class="xanhworld_chat_form" autocomplete="off">
                    ...
                    <textarea id="xanhworldChatInput" name="question" rows="2" placeholder="Nhập câu hỏi (ví dụ: Cảm biến nào phù hợp cho ứng dụng công nghiệp?)" minlength="5" maxlength="200"></textarea>
