                ...
                <div class="autosensor_single_product_related_item animate-scroll animate-up">
                    <a href="/{{ $related['slug'] ?? 'san-pham-lien-quan' }}" class="autosensor_single_product_related_img">
                        <img loading="lazy" decoding="async" src="{{ asset('clients/assets/img/clothes/resize/215x215/' . ($related['image_url'] ?? 'no-image.webp')) }}" 
                            srcset="
                                {{ asset('clients/assets/img/clothes/' . ($related['image_url'] ?? 'no-image.webp')) }} 215w,
                                {{ asset('clients/assets/img/clothes/' . ($related['image_url'] ?? 'no-image.webp')) }} 175w
                            "
                        ...
                        @if(!empty($related['badge']))
                            <span class="autosensor_single_product_related_badge">{{ $related['badge'] }}</span>
                        @endif
                    </a>
                    <div class="autosensor_single_product_related_info">
                        ...
                        <p class="autosensor_single_product_related_price">{{ $related['formatted_price'] ?? '0đ' }}</p>
                    </div>
                </div>
            @endforeach
        @else
